...
export default function Footer() {
  return (
    ...
    {/* <footer className="grid place-items-center bg-black p-6"> */}
      <div className={x.content_footer} >
        <article className={x.div_link} >
        {/* <article className="text-white flex justify-between  h-36"> */}
          <div>
            <strong>Logo</strong>
        ...
        {/* <article className="h-5 text-white grid place-items-center "> */}
